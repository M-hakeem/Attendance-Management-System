...
tr:ntn-child(even) {background-color:#2d2d30}
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <li><a href="dashboard.php"><span class="glyphicon glyphicon-home"></span>DASHBOARD</a></li>
        <li class="active"><a href="semester.php"><span class="glyphicon glyphicon-th-list"></span>SEMESTER</a></li>
		<li><a href="addsemester.php"><span class="glyphicon glyphicon-plus"></span>ADD NEW</a></li>
