...
if(isset($_POST['submit']))
{
   ...
   // $password = password_hash($password, PASSWORD_DEFAULT);  
        $insert_Query = "INSERT INTO `semester` (`Semester_ID`,`Admin_ID`) 
		VALUES ('$Semester_ID', '$AdminID')";
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
	  ...
	  <li><a href="dashboard.php"><span class="glyphicon glyphicon-home"></span>DASHBOARD</a></li>
		...
		<li><a href="semester.php"><span class="glyphicon glyphicon-th-list"></span>SEMESTER</a></li>
...
<form action="addsemester.php" method="POST"> 
  <div class="row">
    <div class="col-sm-6">
      <p color="#333"><b>Semester ID</b></p>
      <input class="form-control"  name="Semester_ID" maxlength="20" placeholder="Enter Semester" type="text" required>
    </div>
    <div class="col-sm-6">
	  <p color="#333"><b>Admin ID</b></p>
      <input class="form-control"  name="AdminID" maxlength="100" placeholder="Enter Address" type="text" value="<?php echo $_SESSION['UID'];?>" readonly>
    </div>
	<div class="col-sm-6">
	</div>
	<div class="col-sm-6">
